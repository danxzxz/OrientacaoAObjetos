...
do {
    ...
    if ($opcao == 0){
        ...
        echo "\nO veículo ". $veiculo->getTipo() .", foi alugado R$ ". $veiculo->getAluguel()  .", rodou ". $veiculo->getKMsrodados() ." quilômetros com custo total de R$ ". $veiculo->ValorViagem() . "\n\n";
    }
